                        ...
                        <div class="widget widget-filter ">
                            ...
                            <ul class="list-unstyled product-attribute-link-list" dir="rtl">
                                @foreach($category as $category_data)
                                    <li><a href="{{ route('products',['slug'=>$category_data->english_name]) }}">{{ $category_data->title }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <!-- END FILTER CATEGORY -->
                                ...
                                <li class="col-md-3">
                                    <div class="product-item" style="margin: 0 auto" title="{{($product_data->title)}}">
                                        ...
                                        <div class="product-info">
                                            <h3 class="title"><a href="shop-product-single.html" title="{{($product_data->title)}}">{{($product_data->title)}}</a></h3>
                                            ...
                                            <div class="bottom ">
                                                ...
                                                <a href="#" class="btn btn-primary "><i class="fa fa-cart-plus"></i> اضافه به سبد خرید</a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
