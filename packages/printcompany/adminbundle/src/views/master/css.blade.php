...
<link href="{{asset('ad_theme/css/icons/icomoon/styles.css')}}" rel="stylesheet" type="text/css">
<link href="{{asset('ad_theme/css/bootstrap.css')}}" rel="stylesheet" type="text/css">
