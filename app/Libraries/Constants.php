...
class Constants
{
    ...
    const TABLE_ROW_NUM = [10,20,30,50,100];

    const TEXT_FOR_CREATE_DATA="درج اطلاعات با موفقیت انجام شد";
    const TEXT_FOR_ERROR="عملیات با خطا مواجه گردید دوباره امتحان کنید";
    const TEXT_FOR_UPDATE_DATA="ویرایش اطلاعات با موفقیت انجام شد";
    const TEXT_FOR_DELETE_DATA="حذف اطلاعات با موفقیت انجام شد";
